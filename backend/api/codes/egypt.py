...
class EgyptianCode:
    """
    Egyptian Code for Concrete (ECP 203) and Steel (ECP 205)
    Structural code handler for Egypt.
    """

    def __init__(self):
        self.name = "Egyptian Code (ECP)"
        self.country = "Egypt"
        self.version = "ECP 203 (Concrete), ECP 205 (Steel)"
    ...
    def analyze_concrete_beam(self, data):
        return analyze_concrete_beam(data, code="ECP")

    def analyze_concrete_column(self, data):
        return analyze_concrete_column(data, code="ECP")

    def analyze_solid_slab(self, data):
        return analyze_solid_slab(data | {"code": "ECP"})

    def analyze_hollow_slab(self, data):
        return analyze_hollow_slab(data | {"code": "ECP"})

    def analyze_waffle_slab(self, data):
        return analyze_waffle_slab(data | {"code": "ECP"})

    def analyze_concrete_footing(self, data):
        return analyze_concrete_footing(data, code="ECP")

    def analyze_concrete_staircase(self, data):
        return analyze_concrete_staircase(data, code="ECP")

    def analyze_steel_beam(self, data):
        return analyze_steel_beam(data, code="ECP 205")

    def analyze_steel_column(self, data):
        return analyze_steel_column(data, code="ECP 205")
    ...
    def analyze_seismic(self, data):
        return {
            ...
            "resistance": 0,
            "status": "safe",
            "recommendations": ["Check seismic zone per ECP-201 map"]
        }
