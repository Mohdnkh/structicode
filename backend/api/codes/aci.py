...
class ACI:
    """
    American Concrete Institute (ACI 318-19) Structural Code Handler
    Provides analysis for concrete and steel elements based on ACI standards.
    """

    def __init__(self):
        self.name = "ACI 318-19"
        self.country = "USA"
        self.version = "2019"
    ...
    def analyze_concrete_beam(self, data):
        return analyze_concrete_beam(data | {"code": "ACI"})

    def analyze_concrete_column(self, data):
        return analyze_concrete_column(data | {"code": "ACI"})

    def analyze_solid_slab(self, data):
        return analyze_solid_slab(data | {"code": "ACI"})

    def analyze_hollow_slab(self, data):
        return analyze_hollow_slab(data | {"code": "ACI"})

    def analyze_waffle_slab(self, data):
        return analyze_waffle_slab(data | {"code": "ACI"})

    def analyze_concrete_footing(self, data):
        return analyze_concrete_footing(data | {"code": "ACI"})

    def analyze_concrete_staircase(self, data):
        return analyze_concrete_staircase(data | {"code": "ACI"})

    # Steel elements
    def analyze_steel_beam(self, data):
        return analyze_steel_beam(data, code="ACI")

    def analyze_steel_column(self, data):
        return analyze_steel_column(data, code="ACI")
