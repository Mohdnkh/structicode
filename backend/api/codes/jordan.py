...
class JordanCode(ACI):
    """
    Jordanian Building Code (JBC)
    Based on ACI with local safety and seismic adjustments.
    """

    def __init__(self):
        super().__init__()
        self.name = "Jordanian Code (JBC)"
        self.country = "Jordan"
        self.version = "Latest (Based on ACI)"
    ...
    def analyze_concrete_beam(self, data):
        return analyze_concrete_beam(data, code="Jordan")

    def analyze_concrete_column(self, data):
        return analyze_concrete_column(data, code="Jordan")

    def analyze_solid_slab(self, data):
        return analyze_solid_slab(data | {"code": "Jordan"})

    def analyze_hollow_slab(self, data):
        return analyze_hollow_slab(data | {"code": "Jordan"})

    def analyze_waffle_slab(self, data):
        return analyze_waffle_slab(data | {"code": "Jordan"})

    def analyze_concrete_footing(self, data):
        return analyze_concrete_footing(data, code="Jordan")

    def analyze_concrete_staircase(self, data):
        return analyze_concrete_staircase(data, code="Jordan")

    def analyze_steel_beam(self, data):
        return analyze_steel_beam(data, code="Jordan")
    ...
    def analyze_seismic(self, data):
        ...
        result["recommendations"].append("Check local seismic zoning map for Jordan")
        return result
